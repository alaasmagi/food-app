...
The system SHALL fetch daily restaurant offers only when GetDailyOffersAsync or the daily offers API endpoint is requested.
...
#### Scenario: No scheduled fetch
- **WHEN** the application starts or runs background services
